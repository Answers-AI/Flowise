...
declare type ArgValue = string | boolean | number | undefined | Args_3 | string[] | boolean[] | number[] | Args_3[] | Date | null
...
export declare type ClientBuiltInProp = '$connect' | '$disconnect' | '$transaction' | '$extends'
...
> = {
    ...
    [P in Exclude<keyof TypeMap['other']['operations'], keyof ExtArgs['client']>]: <
        R = GetResult_2<TypeMap['other']['operations'][P]['payload'], any, P & Operation>
    >(
...
export declare type DynamicModelExtensionThis<TypeMap extends TypeMapDef, M extends PropertyKey, ExtArgs extends Record<string, any>> = {
    ...
    >]: {} extends TypeMap['model'][M]['operations'][P]['args']
        ? <A extends TypeMap['model'][M][P]['args']>(
              args?: A
          ) => PrismaPromise<GetResult_2<TypeMap['model'][M]['operations'][P]['payload'], A, P & Operation>>
        : <A extends TypeMap['model'][M]['operations'][P]['args']>(
              args: A
          ) => PrismaPromise<GetResult_2<TypeMap['model'][M]['operations'][P]['payload'], A, P & Operation>>
} & {
    [P in Exclude<'fields' & keyof TypeMap['model'][M], keyof ExtArgs['model'][Uncapitalize<M & string>]>]: TypeMap['model'][M]['fields']
} & {
    [K: symbol]: {
...
export declare type DynamicResultExtensionData<TypeMap extends TypeMapDef, M extends PropertyKey, S> = GetFindResult<
    TypeMap['model'][M]['operations']['findFirstOrThrow']['payload'],
    {
        select: S
    }
>
...
declare type GetFindResult<P extends Payload, A> = {} extends A
    ...
    ? {
          [K in keyof S as S[K] extends false | undefined | null ? never : K]: S[K] extends object
...
export declare function getPrismaClient(config: GetPrismaClientConfig): {
    new (optionsArg?: PrismaClientOptions): {
        ...
        _getProtocolEncoder: (params: Pick<InternalRequestParams, 'clientMethod' | 'callsite'>) => Promise<ProtocolEncoder<EngineQuery>>
...
declare type Path<O, P, Default = never> = P extends [infer K, ...infer R] ? (K extends keyof O ? Path<O[K], R> : Default) : O
...
declare namespace Public_2 {
    export { Args_4 as Args, Result, Payload_2 as Payload, PrismaPromise, Operation, Exact }
}
...
declare type Result<T, A, F extends Operation> = T extends {
    ...
    ? GetResult_2<T[symbol]['types']['operations'][F]['payload'], A, F>
    : never
...
declare namespace Types {
    export { Extensions_2 as Extensions, Utils, Public_2 as Public, GetResult_2 as GetResult, Payload, DefaultSelection }
}
export { Types }
...
declare function validator<C, M extends Exclude<keyof C, `$${string}`>, O extends keyof C[M] & Operation, P extends keyof Args_4<C[M], O>>(
    client: C,
    model: M,
    operation: O,
    prop: P
