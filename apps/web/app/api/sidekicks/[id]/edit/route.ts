...
export async function PATCH(req: Request) {
    try {
        ...
        // @ts-ignore-next-line
        const dbFields = prisma._runtimeDataModel.models.Sidekick.fields.map((field: any) => field.name)
        ...
        return NextResponse.json({ error: 'There was an error creating your sidekick.', code: error.message }, { status: 422 })
    }
}
