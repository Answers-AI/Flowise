...
export async function PATCH(req: Request, { params: { id } }: { params: { id: string } }, res: Response) {
    try {
        ...
        return NextResponse.json({ error: 'There was an error updating your favorite' }, { status: 422 })
        throw error
    }
}
